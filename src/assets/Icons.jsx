...
import { 
  ...
  ChevronLeft, ChevronRight // <-- ADD THESE
} from 'lucide-react';
...
export const MakeBrandIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w.org/2000/svg">
...
export const ChevronLeftIcon = ChevronLeft; // <-- EXPORT
export const ChevronRightIcon = ChevronRight; // <-- EXPORT