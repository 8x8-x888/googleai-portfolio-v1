...
export const PROJECTS = [
  {
    ...
    quote:
      'Streamlines order tracking and CRM updates, cutting manual work and ensuring the team responds faster to every opportunity.',
    tools: [
  ...
  },
  {
    ...
    quote:
      'Cuts through inbox clutter, blocks spam, and extracts financial info, saving hours of manual data entry every week.',
    tools: [
  ...
  },
  {
    ...
    quote:
      'Automates regional sales reporting from multiple data sources, sending formatted reports via email and Discord.',
    tools: [
